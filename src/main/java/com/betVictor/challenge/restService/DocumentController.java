...
public class DocumentController {
    ...
    public String insertDocument(@RequestParam String collection, @RequestParam String content) {
        return servicesMediator.insertDocument(collection, content).toJson();
    }
    ...
    public String updateDocument(@RequestParam String collection, @RequestParam long id, @RequestParam String content) {
        return servicesMediator.updateDocument(collection, id, content).toJson();
    }

    @DeleteMapping("/deleteDocument")
    @ApiOperation(value = "Delete a document")
    public String deleteDocument(@RequestParam String collection, @RequestParam long id) {
